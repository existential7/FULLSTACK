...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<List<User>>> getAllUsers() {
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Users retrieved successfully", userService.getAllUsers())
        );
    }
    ...
    public ResponseEntity<ApiResponse<User>> getUser(@PathVariable String uid) {
        return ResponseEntity.ok(
                new ApiResponse<>(true, "User retrieved successfully", userService.getUserByUid(uid))
        );
    }
